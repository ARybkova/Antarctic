...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_2__["toggleMenu"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_3__["scrollToElement"])();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_map__WEBPACK_IMPORTED_MODULE_4__["getMap"])();
  });
});
...
var toggleMenu = function toggleMenu() {
  ...
  var navLinks = navMain.querySelectorAll('.navigation__item');
  var overlay = document.querySelector('.main-header__overlay');
...
var COORDINATES = [59.938631, 30.323037];
var ZOOM = 16;
var getMap = function getMap() {
  var yandexMap = window.ymaps;
  yandexMap.ready(function () {
    var myMap = new yandexMap.Map('map', {
      center: COORDINATES,
      zoom: ZOOM
    }, {
      searchControlProvider: 'yandex#search'
    });
    var pin = new yandexMap.Placemark(COORDINATES, {}, {
...
var scrollToElement = function scrollToElement() {
  var smoothScrollElements = document.querySelectorAll('a[href^="#"]:not(a[href="#"])');
  smoothScrollElements.forEach(function (smoothScrollElement) {
    smoothScrollElement.addEventListener('click', function (evt) {
      evt.preventDefault();
      var id = smoothScrollElement.getAttribute('href');
